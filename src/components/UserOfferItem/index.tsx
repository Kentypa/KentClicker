...
export const UserOfferItem: FC<UserOfferItemProps> = ({ offer }) => {
  return (
    <li className='border hover:border-primary border-subtle-light rounded-[10px] p-5.75 flex flex-col gap-4'>
            ...
            <div className='flex items-center'>
              ...
              <div className='flex items-center'>
                <p className='text-headline-small'>
                  {offer.pricePerCoin}&nbsp;
                  <span className='text-body-large text-subtle-dark self-end'>/coin</span>
                </p>
              </div>
            </div>
          </div>
